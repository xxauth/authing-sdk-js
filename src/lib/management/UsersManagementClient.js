...
var UsersManagementClient = /** @class */ (function () {
    function UsersManagementClient(options, graphqlClient, httpClient, tokenProvider) {
     ...
     */
    UsersManagementClient.prototype.create = function (userInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(userInfo && userInfo.password)) return [3 /*break*/, 2];
                        _a = userInfo;
                        return [4 /*yield*/, this.options.encryptFunction(userInfo.password, this.options.encrptionPublicKey)];
                    case 1:
                        _a.password = _b.sent();
                        _b.label = 2;
                    case 2: return [4 /*yield*/, graphqlapi_1.createUser(this.graphqlClient, this.tokenProvider, {
                            userInfo: userInfo
                        })];
                    case 3:
                        user = (_b.sent()).createUser;
    ...
    UsersManagementClient.prototype.update = function (id, updates) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(updates && updates.password)) return [3 /*break*/, 2];
                        _a = updates;
                        return [4 /*yield*/, this.options.encryptFunction(updates.password, this.options.encrptionPublicKey)];
                    case 1:
                        _a.password = _b.sent();
                        _b.label = 2;
                    case 2: return [4 /*yield*/, graphqlapi_1.updateUser(this.graphqlClient, this.tokenProvider, {
                            id: id,
                            input: updates
                        })];
                    case 3:
                        user = (_b.sent()).updateUser;
                        return [2 /*return*/, user];
                }
            });
        });
    ...
    UsersManagementClient.prototype.detail = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, graphqlapi_1.user(this.graphqlClient, this.tokenProvider, {
                            id: userId
                        })];
                    case 1:
                        data = (_a.sent()).user;
    ...
    UsersManagementClient.prototype.batch = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, graphqlapi_1.userBatch(this.graphqlClient, this.tokenProvider, {
                            ids: ids
                        })];
                    case 1:
    ...
    UsersManagementClient.prototype.list = function (page, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, graphqlapi_1.users(this.graphqlClient, this.tokenProvider, {
                            page: page,
                            limit: limit
                        })];
                    case 1:
    ...
    UsersManagementClient.prototype.search = function (query, options) {
        return __awaiter(this, void 0, void 0, function () {
            var fields, _a, page, _b, limit, users;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        options = options || {};
                        fields = options.fields, _a = options.page, page = _a === void 0 ? 1 : _a, _b = options.limit, limit = _b === void 0 ? 10 : _b;
     ...
     * @memberof UsersManagementClient
     */
    UsersManagementClient.prototype.listRoles = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var roles;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @memberof UsersManagementClient
     */
    UsersManagementClient.prototype.addRoles = function (userId, roles) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @memberof UsersManagementClient
     */
    UsersManagementClient.prototype.removeRoles = function (userId, roles) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
